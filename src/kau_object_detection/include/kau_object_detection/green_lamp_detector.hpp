...
#ifndef KAU_OBJECT_DETECTION__GREEN_LAMP_DETECTOR_HPP_
#define KAU_OBJECT_DETECTION__GREEN_LAMP_DETECTOR_HPP_
...
#endif  // KAU_OBJECT_DETECTION__GREEN_LAMP_DETECTOR_HPP_
