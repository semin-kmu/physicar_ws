...
// 원본: kmu_amet_test / src/sim_common/curve.py  (docs/경로_형식.md 구현)
//
...
#ifndef KAU_LANE_DETECTION__BEZIER_HPP_
#define KAU_LANE_DETECTION__BEZIER_HPP_
...
#endif  // KAU_LANE_DETECTION__BEZIER_HPP_
