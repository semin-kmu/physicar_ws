...
// ---------------------------------------------------------------------------
// Forked from package "kau_object_detection", its test test_green_lamp_detector.cpp,
// on 2026-08-25.
...
using kau_object_detection_lane::GreenLampOptions;
using kau_object_detection_lane::detect_green_lamp;
using kau_object_detection_lane::validate_green_lamp_options;
