...
// ---------------------------------------------------------------------------
// Forked from package "kau_object_detection", its test test_laser_scan_validator.cpp,
// on 2026-08-25.
...
kau_object_detection_lane::ScanValidationOptions physicar_options()
{
  kau_object_detection_lane::ScanValidationOptions options;
...
TEST(LaserScanValidator, AcceptsObservedPhysicarGeometryAndZeroTiming)
{
  ...
  const auto result =
    kau_object_detection_lane::validate_laser_scan(scan, physicar_options());
