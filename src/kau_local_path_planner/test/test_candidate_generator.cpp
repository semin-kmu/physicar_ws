...
using kau::local_path_planner::committedSegmentCount;
using kau::local_path_planner::fitSegment;
using kau::local_path_planner::Frame;
using kau::local_path_planner::hermiteToBezier;
using kau::local_path_planner::kCommittedHorizonCm;
using kau::local_path_planner::Knot;
using kau::local_path_planner::kPredictionViolationPenalty;
